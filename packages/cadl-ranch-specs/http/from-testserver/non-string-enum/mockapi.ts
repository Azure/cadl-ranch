...
Scenarios.NonStringEnums_Int_put = passOnSuccess(
...
Scenarios.NonStringEnums_Int_get = passOnSuccess(
  mockapi.get("/nonStringEnums/int/get", () => {
    return { status: 200, body: json(429) };
  }),
);

Scenarios.NonStringEnums_Float_put = passOnSuccess(
...
Scenarios.NonStringEnums_Float_get = passOnSuccess(
