...
Scenarios.Encode_Duration_Property_Default = createBodyServerTests("/encode/duration/property/default", {
  value: "P40D",
});
Scenarios.Encode_Duration_Float_Seconds = createBodyServerTests("/encode/duration/property/float-seconds", {
  value: 35.625,
});
Scenarios.Encode_Duration_Float64_Seconds = createBodyServerTests("/encode/duration/property/float64-seconds", {
  value: 35.625,
});
Scenarios.Encode_Duration_Int32_Seconds = createBodyServerTests("/encode/duration/property/int32-seconds", {
  value: 36,
});
Scenarios.Encode_Duration_Iso8601 = createBodyServerTests("/encode/duration/property/iso8601", {
  value: "P40D",
});
Scenarios.Encode_Duration_Float_Seconds_Array = createBodyServerTests("/encode/duration/property/float-seconds-array", {
  value: [35.625, 46.75],
});
...
Scenarios.Encode_Duration_Query_Int32_Seconds = createQueryServerTests("/encode/duration/query/int32-seconds", {
  input: 36,
});
...
Scenarios.Encode_Duration_Query_Float_Seconds = createQueryServerTests("/encode/duration/query/float-seconds", {
  input: 35.625,
});
Scenarios.Encode_Duration_Query_Float64_Seconds = createQueryServerTests("/encode/duration/query/float64-seconds", {
  input: 35.625,
});
...
Scenarios.Encode_Duration_Header_Iso8601 = createHeaderServerTests("/encode/duration/header/iso8601", {
  duration: "P40D",
});
Scenarios.Encode_Duration_Header_Int32_Seconds = createHeaderServerTests("/encode/duration/header/int32-seconds", {
  duration: 36,
});
Scenarios.Encode_Duration_Header_Float_Seconds = createHeaderServerTests("/encode/duration/header/float-seconds", {
  duration: 35.625,
});
Scenarios.Encode_Duration_Header_Float64_Seconds = createHeaderServerTests("/encode/duration/header/float64-seconds", {
  duration: 35.625,
});
Scenarios.Encode_Duration_Header_Iso8601_Array = createHeaderServerTests("/encode/duration/header/iso8601-array", {
