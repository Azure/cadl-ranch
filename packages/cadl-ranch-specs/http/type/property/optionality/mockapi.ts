...
Scenarios.Type_Property_Optional_String_Default = createServerTests(`/type/property/optional/string/default`, {});
Scenarios.Type_Property_Optional_Bytes_Default = createServerTests(`/type/property/optional/bytes/default`, {});
Scenarios.Type_Property_Optional_DateTime_Default = createServerTests(`/type/property/optional/datetime/default`, {});
Scenarios.Type_Property_Optional_Duration_Default = createServerTests(`/type/property/optional/duration/default`, {});
Scenarios.Type_Property_Optional_PlainDate_Default = createServerTests(`/type/property/optional/plainDate/default`, {});
Scenarios.Type_Property_Optional_PlainTime_Default = createServerTests(`/type/property/optional/plainTime/default`, {});
...
Scenarios.Type_Property_Optional_String_All = createServerTests(`/type/property/optional/string/all`, {
  property: "hello",
});
Scenarios.Type_Property_Optional_Bytes_All = createServerTests(`/type/property/optional/bytes/all`, {
  property: "aGVsbG8sIHdvcmxkIQ==",
});
Scenarios.Type_Property_Optional_DateTime_All = createServerTests(`/type/property/optional/datetime/all`, {
  property: "2022-08-26T18:38:00Z",
});
Scenarios.Type_Property_Optional_Duration_All = createServerTests(`/type/property/optional/duration/all`, {
  property: "P123DT22H14M12.011S",
});
Scenarios.Type_Property_Optional_PlainDate_All = createServerTests(`/type/property/optional/plainDate/all`, {
  property: "2022-12-12",
});
Scenarios.Type_Property_Optional_PlainTime_All = createServerTests(`/type/property/optional/plainTime/all`, {
  property: "13:06:12",
});
...
Scenarios.Type_Property_Optional_String_Literal_All = createServerTests(`/type/property/optional/string/literal/all`, {
  property: "hello",
});
Scenarios.Type_Property_Optional_Int_Literal_All = createServerTests(`/type/property/optional/int/literal/all`, {
  property: 1,
});
Scenarios.Type_Property_Optional_Float_Literal_All = createServerTests(`/type/property/optional/float/literal/all`, {
  property: 1.25,
});
