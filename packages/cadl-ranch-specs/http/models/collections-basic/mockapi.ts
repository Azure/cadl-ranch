...
Scenarios.CollectionProperties_sendCollectionModel = passOnSuccess(
...
Scenarios.CollectionProperties_getCollectionModel = passOnSuccess(
  mockapi.get("/collection-properties-basic/models", () => {
    return { status: 200, body: json({ requiredStringList: ["get"], requiredIntList: [101] }) };
  }),
);
Scenarios.CollectionProperties_setCollectionModel = passOnSuccess(
